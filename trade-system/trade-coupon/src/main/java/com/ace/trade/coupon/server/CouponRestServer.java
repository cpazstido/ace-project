package com.ace.trade.coupon.server;
...
public class CouponRestServer {
    public static void main(String[] args) throws Exception {
        Server server = new Server(TradeEnum.RestServerEnum.COUPON.getServerPort());
        ServletContextHandler springMvcHandler = new ServletContextHandler();
        springMvcHandler.setContextPath("/"+TradeEnum.RestServerEnum.COUPON.getContextPath());
